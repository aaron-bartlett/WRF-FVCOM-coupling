...
!
! REVISION:
! 12 Mar 2012:  Started 2.0 rewrite.
! 18 Apr 2012:  Moved saturation specific humidity calculation to new module.
!------------------------------------------------------------------------------
...
module MerraData_mod
   ...
   type MerraData
      ...
      real, allocatable :: tsoil1(:,:,:)
      real, allocatable :: tsoil2(:,:,:)
      real, allocatable :: tsoil3(:,:,:)
      real, allocatable :: tsoil4(:,:,:)
      real, allocatable :: tsoil5(:,:,:)
      real, allocatable :: tsoil6(:,:,:)
   ...
   character(len=32), parameter :: MAP_SOURCE='MERRA/NASA GMAO'
...
contains
   ...
   subroutine destroyMerraData(this)
      ...
      if (allocated(this%tsoil1)) &
           deallocate(this%tsoil1)
      if (allocated(this%tsoil2)) &
           deallocate(this%tsoil2)
      if (allocated(this%tsoil3)) &
           deallocate(this%tsoil3)
      if (allocated(this%tsoil4)) &
           deallocate(this%tsoil4)
      if (allocated(this%tsoil5)) &
           deallocate(this%tsoil5)
      if (allocated(this%tsoil6)) &
           deallocate(this%tsoil6)
   ...
   subroutine readConst2dAsmNx(this,fileFormat,filename) 
      ...
      ! Get lat/lon info
      if (fileFormat == HDFEOS2_FORMAT ) then 
        call getLatLon(this,fileFormat,fileID)
      else
   ...
   subroutine readInst63dAnaNv(this,fileFormat,filename) 
      ...
      if (fileFormat == HDFEOS2_FORMAT .or. fileFormat == NETCDF_FORMAT ) then
   ...
   !---------------------------------------------------------------------------
   !
   ! ROUTINE:  readTavg12dLndNx
   !
   ! DESCRIPTION:  Public method for processing MERRA tavg1_2d_lnd_Nx files.
   !
   !---------------------------------------------------------------------------

   subroutine readTavg12dLndNx(this,fileFormat,filename)
      ...
      if (fileFormat == HDFEOS2_FORMAT .or. fileFormat == NETCDF_FORMAT) then
         call readRealArray3d(fileFormat,fileID,'TSOIL1',dim1,dim2,dim3,tsoil1)
         call readRealArray3d(fileFormat,fileID,'TSOIL2',dim1,dim2,dim3,tsoil2)
         call readRealArray3d(fileFormat,fileID,'TSOIL3',dim1,dim2,dim3,tsoil3)
         call readRealArray3d(fileFormat,fileID,'TSOIL4',dim1,dim2,dim3,tsoil4)
         call readRealArray3d(fileFormat,fileID,'TSOIL5',dim1,dim2,dim3,tsoil5)
         call readRealArray3d(fileFormat,fileID,'TSOIL6',dim1,dim2,dim3,tsoil6)
      else
         call readRealArray3d(fileFormat,fileID,'TSOIL1',dim1,dim2,dim3,tsoil1)
         call readRealArray3d(fileFormat,fileID,'TSOIL2',dim1,dim2,dim3,tsoil2)
         call readRealArray3d(fileFormat,fileID,'TSOIL3',dim1,dim2,dim3,tsoil3)
      ...
      allocate(this%tsoil1(this%longitudeDimension, &
           this%latitudeDimension, this%timeDimension))
      allocate(this%tsoil2(this%longitudeDimension, &
           this%latitudeDimension, this%timeDimension))
      allocate(this%tsoil3(this%longitudeDimension, &
           this%latitudeDimension, this%timeDimension))
      allocate(this%tsoil4(this%longitudeDimension, &
           this%latitudeDimension, this%timeDimension))
      allocate(this%tsoil5(this%longitudeDimension, &
           this%latitudeDimension, this%timeDimension))
      allocate(this%tsoil6(this%longitudeDimension, &
           this%latitudeDimension, this%timeDimension))
      do mm = 1, this%timeDimension
         do jj = 1, this%latitudeDimension
            do ii = 1, this%longitudeDimension
               this%tsoil1(ii,jj,mm) = tsoil1(ii,jj,indices(mm))
               this%tsoil2(ii,jj,mm) = tsoil2(ii,jj,indices(mm))
               this%tsoil3(ii,jj,mm) = tsoil3(ii,jj,indices(mm))
               this%tsoil4(ii,jj,mm) = tsoil4(ii,jj,indices(mm))
               this%tsoil5(ii,jj,mm) = tsoil5(ii,jj,indices(mm))
               this%tsoil6(ii,jj,mm) = tsoil6(ii,jj,indices(mm))
            end do
         end do
      end do
      deallocate(tsoil1,tsoil2,tsoil3,tsoil4,tsoil5,tsoil6)
   ...
   end subroutine readTavg12dLndNx
   ...
   subroutine getTimeIndices(this,fileFormat,fileID,indices, &
      ...
      ! Get times array
      if (fileFormat == HDFEOS2_FORMAT) then
         call readDoubleArray1d(fileFormat,fileID,'TIME:EOSGRID', &
              fileTimeDimension, times) 
         do i = 1, fileTimeDimension
            times(i) = times(i)/60
         end do
      elseif (fileFormat == NETCDF_FORMAT) then
         ...
         call readDoubleArray1d(fileFormat,fileID,'time',fileTimeDimension, &
              times)
      end if
   ...
   subroutine checkLatLon(this,fileFormat,fileID)
      ...
      elseif (fileFormat == NETCDF_FORMAT) then
         ...
         call readDoubleArray1d(fileFormat,fileID,'longitude',dim1,longitudes)
      end if
      ...
      elseif (fileFormat == NETCDF_FORMAT) then
         ...
         call readDoubleArray1d(fileFormat,fileID,'latitude',dim1,latitudes)
      end if
   ...
   subroutine getTimesVerticalLevels(this,fileFormat,fileID)
      ...
      ! Get times
      if (fileFormat == HDFEOS2_FORMAT) then
         call readDoubleArray1d(fileFormat,fileID,'TIME:EOSGRID',dim1,times)
      elseif (fileFormat == NETCDF_FORMAT) then 
          call readIntegerArray1d(fileFormat,fileID,'time',dim1,times1)
          allocate(times(dim1)) 
          times = dble(times1)
      else
         call readDoubleArray1d(fileFormat,fileID,'time',dim1,times)
      end if
      ...
      if (fileFormat == HDFEOS2_FORMAT .or.fileFormat == NETCDF_FORMAT) then
         ...
         do m = 1, this%timeDimension
            this%synopticHours(m) = nint(times(m))
         end do
      end if
      deallocate(times)
      ...
      ! Get levels
      if (fileFormat == HDFEOS2_FORMAT) then
         call readDoubleArray1d(fileFormat,fileID,'Height',dim1,levels)
      elseif (fileFormat == NETCDF_FORMAT) then
         call readDoubleArray1d(fileFormat,fileID,'lev',dim1,levels)
      else         
         call readDoubleArray1d(fileFormat,fileID,'levels',dim1,levels)
      end if
