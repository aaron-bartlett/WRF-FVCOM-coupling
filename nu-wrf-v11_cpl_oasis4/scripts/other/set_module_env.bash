...
export LIBDIR_TAG=/compass/glm200001/cmu/coupled-run/libs
export LIBDIR=/compass/glm200001/cmu/coupled-run/libs
...
#elif [[ "$MACHINE" =~ "compass" ]]; then
#   export platform="compass"
#   [ -z "$LIBDIR" ] && LIBDIR_=/compass/glm200001/cmu/coupled-run/libs
fi
