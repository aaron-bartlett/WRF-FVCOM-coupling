...
#SBATCH --ntasks=14 #125                # must equal WRF_TASKS + FVCOM_TASKS below
...
########################################
WRF_TASKS=8 #70                        # must match the "awrf" count in namcouple $NBMODEL
FVCOM_TASKS=6 #55                       # must match the "lfvc" count in namcouple $NBMODEL
